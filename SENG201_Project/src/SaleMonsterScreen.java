...
public class SaleMonsterScreen {
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(SaleMonsterScreen.class.getResource("/Images/Monster/Witch.png")));
		lblNewLabel.setBounds(171, 8, 116, 65);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon(SaleMonsterScreen.class.getResource("/Images/Monster/Bat.png")));
		lblNewLabel_1.setBounds(178, 85, 116, 65);
		frame.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("New label");
		lblNewLabel_2.setIcon(new ImageIcon(SaleMonsterScreen.class.getResource("/Images/Monster/Skeleton.png")));
		lblNewLabel_2.setBounds(171, 162, 116, 65);
		frame.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_2_1 = new JLabel("New label");
		lblNewLabel_2_1.setIcon(new ImageIcon(SaleMonsterScreen.class.getResource("/Images/Monster/Slime.png")));
